...
class ProdutoService {
    ...
    async atualizarProduto(id, dados) {
        ...
        const existe = await ProdutoRepository.listarProdutoPorId(id);
        if (!existe) 
            throw { 
                status: 404, 
                mensagem: "Produto não encontrado" 
        ...
        await ProdutoRepository.atualizarProduto(id, atualizado);
        return { 
            sucesso: true, 
    ...
    async deletarProduto(id) {
        ...
        await ProdutoRepository.deletarProdutos(id);
        return { 
            sucesso: true, 
